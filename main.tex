...
Paper contributions:
\begin{enumerate}
    \item Unification of traffic assignment problems under a clear variational inequality formulation (with good notation).
    \item A modular software framework with solvers based on the unified variational inequality formulation.
